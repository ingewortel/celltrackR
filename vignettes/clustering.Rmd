...
```{r, fig.show="hide"}
pca <- clusterTracks( all.tracks, 
                      c(speed,meanTurningAngle,squareDisplacement,
                        maxDisplacement,outreachRatio ), 
...
Uniform manifold approximate and projection (UMAP) is another powerful method to explore structure in high-dimensional datasets. `clusterTracks()` supports visualization of tracks in a UMAP. Note that this option requires the `uwot` package. Please install this package first using `install.packages("uwot")`. 
